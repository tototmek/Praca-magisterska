...
\begin{minted}
[
    label={include/connection.cpp > Receiver::receiveReading}, 
    linenos, 
    frame=single, 
    framesep=0.5em, 
    fontsize=\small
...
\begin{minted}
[
    label={include/connection.cpp > Transmitter::transmitReading}, 
    linenos, 
    frame=single, 
    framesep=0.5em, 
    fontsize=\small
...
TODO: tutaj też o tym, że remapowana jest numeracja tuneli


TODO: tutaj coś o tym, że w eepromie zapisuję który mikrokontroler jest poboczny, a który główny, a firmware jest dokładnie ten sam
\subsection{Testy}

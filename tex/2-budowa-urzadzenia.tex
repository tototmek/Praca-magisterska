...
\begin{figure}
    ...
    \caption{Schemat systemu z dwoma mikrokontrolerami i ośmioma bramkami.}
    \label{fig:system-schemat}
\end{figure}
  \subsubsection{Dobór komponentów}
Przedstawiony w poprzedniej części pracy sposób akwizycji sygnału z czujnika pojemnościowego nie wymaga wiele komponentów układu.
Poza samym 

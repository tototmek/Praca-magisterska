...
Implementacja omawianego automatu zawarta jest funkcji \texttt{Receiver::receiveReading} z pliku \texttt{src/connection.cpp}, którego odpowiedni fragment przedstawiono na poniższym fragmencie kodu.
...
Szczegółowa implementacja ustawiania i sprawdzania trybu mikrokontrolera nie zostanie przedstawiona w niniejszej pracy, można się z nią natomiast zapoznać w kodzie źródłowym projektu -- w plikach \texttt{include/connection.h}, \texttt{src/connection.cpp} oraz \texttt{src/main.cpp}. 
...
\end{enumerate}
Dane zebrane podczas niniejszego eksperymentu zostały przedstawione na rysunku \ref{fig:test-zlozenia}.
\begin{figure}[htb]
    \centering
    \caption{Przebiegi sygnałów wyjściowych bramek $x_0$--$x_7$ podczas testu działania urządzenia.}
